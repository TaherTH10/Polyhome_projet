package com.taher.PolyHome.network
...
class Api {
    ...
    public inline fun <reified K, reified T> post(
        path: String,
        data: K,
        crossinline onSuccess: (Int, T?) -> Unit,
        securityToken: String? = null
    ...
    public inline fun <reified K> post(
        path: String,
        data: K,
    ...
    public inline fun <reified K> put(
        path: String,
        data: K,
        crossinline onSuccess: (Int) -> Unit,
        securityToken: String? = null
    ...
    public inline fun <reified K> delete(
        path: String,
        data: K,
        crossinline onSuccess: (Int) -> Unit,
        securityToken: String? = null
